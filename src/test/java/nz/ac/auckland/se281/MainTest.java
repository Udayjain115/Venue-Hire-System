...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void NoVenueCode() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES,
              SET_DATE,
    ...
    @Test
    public void Today_Already_Booked() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
    ...
    @Test
    public void Today_Tommrow_Flipped_Order() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
    ...
    @Test
    public void Skipping_Days() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
    ...
    @Test
    public void SystemDate_UPDATE() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
    ...
    @Test
    public void MULTIPLE_VENUES() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
              ...
              "05/02/2024", //
              MAKE_BOOKING,
              options("MMM", "06/02/2024", "client001@email.com", "230"),
              MAKE_BOOKING,
    ...
    @Test
    public void OUT_OF_ORDER_BOOKINGS() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
    ...
    @Test
    public void T4_11_booking_next_available_date_after_making_bookings() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
